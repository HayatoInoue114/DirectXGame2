...
//#include "../Particle.h"
//
//ModelData ParticleCommon::LoadObjFile(const std::string& directoryPath, const std::string& filename) {
...
//}
//
//Microsoft::WRL::ComPtr<ID3D12Resource> ParticleCommon::CreateBufferResource(const Microsoft::WRL::ComPtr<ID3D12Device>& device, size_t sizeInBytes) {
//	HRESULT hr;
//	// 頂点リソース用のヒープの設定
...
//
//
//ParticleData ParticleCommon::MakeNewParticle(std::mt19937& randomEngine) {
...
//}
//
//void ParticleCommon::Initialize(Particle* pParticle) {
//
//	pParticle;
//
//	numInstance_ = pParticle->
//
//	//Transform変数を作る
...
//}
//
//void ParticleCommon::CreateVertexBufferView() {
//	vertexBufferView_ = {};
//	//リソースの先頭のアドレスから使う
...
//}
//
//void ParticleCommon::WriteDataToResource() {
//	//書き込むためのアドレスを取得
...
//}
//
//void ParticleCommon::CreateWVPMatrix() {
//	//カメラ
...
//}
//
//void ParticleCommon::SetMaterialData() {
//	// 色の設定
...
//}
//
//void ParticleCommon::LoadModel(const std::string& filename) {
//	//モデル読み込み
...
//}
//
//void ParticleCommon::CreateInstance() {
...
//
//
//void ParticleCommon::Update() {
//	for (std::list<ParticleData>::iterator particleIterator = particles_.begin(); particleIterator != particles_.end(); ++particleIterator) {
//		// 生存時間が過ぎたら処理を行わない
...
//}
//
//void ParticleCommon::Draw(Camera* camera, uint32_t textureNum) {
//	CreateWVPMatrix();
//	// カメラ行列
...
//}
//
//ParticleData ParticleCommon::MakeNewParticle(const Vector3& translate) {
//	//// 座標
//	//std::uniform_real_distribution<float> distribution(-1.0f, 1.0f);
//	//// 速度
...
//
//	Scope time = { 60.0f,300.0f };
//	particle.lifeTime = RandomGenerator::getRandom(time);
//	particle.currentTime = 0;
//	return particle;
//}
//
//std::list<ParticleData> ParticleCommon::Emission(const Emitter& emitter)
//{
...
//}
//
//void ParticleCommon::ImGuiAdjustParameter() {
//	/*std::random_device seedGenerator;
//	std::mt19937 randomEngine(seedGenerator());*/
//
...
//}
//
//Matrix4x4 ParticleCommon::AffineMatrix(const Vector3& scale, const Matrix4x4& rotateMatrix, const Vector3& translate) {
//	// 計算結果
//	Matrix4x4 result{};
//
//	// アフィン変換行列の計算
